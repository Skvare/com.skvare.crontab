 ...
 */
class CRM_Crontab_Upgrader_Base {

  /**
   * @var CRM_Crontab_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      // FIXME auto-generate
      self::$instance = new CRM_Crontab_Upgrader(
        'com.skvare.crontab',
        realpath(__DIR__ . '/../../../')
      );
    }
   ...
   *
   * ```
   * CRM_Crontab_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Crontab_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
